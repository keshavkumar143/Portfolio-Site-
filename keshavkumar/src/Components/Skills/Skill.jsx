...
import { 
  ...
  faNodeJs, faJava, faAws, faGitAlt, 
  faFigma, faAngular 
...
function Skill() {
  ...
  const skills = [
    ...
    { name: 'Figma', icon: faFigma, color: 'text-purple-500', description: 'Figma' },
    { name: 'Angular', icon: faAngular, color: 'text-red-600', description: 'Angular' }
  ];
      ...
      >
        ...
        >
          ...
          <p className="text-lg text-gray-300 max-w-2xl mx-auto">
            My technical toolkit for creating powerful and responsive web applications.
          </p>
        </motion.div>
